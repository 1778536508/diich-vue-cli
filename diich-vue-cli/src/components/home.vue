          ...
          <div class="row">
            <div class="container-fluid">
              <div class="col-sm-6 text-center">
                <h2>123</h2>
                <p>作品</p>
                <span>Intangible works</span>
              </div>
              <div class="col-sm-6 text-center">
                <i class="fa fa-codepen fa-spin"></i>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-6 text-center">
                <i class="fa fa-drupal fa-spin"></i>
              </div>
            </div>
          </div>
    ...
    drawLine() {
      ...
      var option = {
        ...
        title: [
          {
            text: '中国非遗统计',
            subtext: 'data from Intangibleheritage',
